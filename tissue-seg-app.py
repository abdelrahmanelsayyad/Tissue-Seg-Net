...
def get_mobile_friendly_css(COL):
    return f"""
<style>
  /* Base Styles */
  .stApp {{ 
...
def apply_mobile_css():
    """Apply mobile-friendly CSS"""
    COL = get_theme_colors()
    mobile_css = get_mobile_friendly_css(COL)
...
def create_upload_section():
    ...
    mobile_mode = st.checkbox("📱 Mobile Interface", help="Switch to mobile-optimized interface")
...
# Call the function
uploaded, camera_image, mobile_mode = create_upload_section()
